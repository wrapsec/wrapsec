        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{ fontSize: "13px", color: "rgba(255,255,255,0.45)", margin: 0, lineHeight: 1.6 }}>
              Protect every request before it reaches your LLM. <br />Built for developers and security teams.
            </p>
          </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {[
              ...
              { icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z", label: "PII protection for sensitive data" },
