...
yes Decide on fail open vs fail closed for your risk tolerance
yes Log trace_id with every blocked/sanitized request for audit trail
yes Use mode="full" for sensitive endpoints requiring deeper analysis
