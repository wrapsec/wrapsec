...
def _build_wrapsec_headers(
    ...
    headers = {
        ...
        "X-WrapSec-Input-Sanitized":      str(input_was_sanitized).lower(),
        "X-WrapSec-Output-Decision":      output_decision or "N/A",
        "X-WrapSec-Output-Sanitized":     str(output_was_sanitized).lower(),
...
async def proxy_chat_completions(
    ...
    if inline:
        response_body["wrapsec"] = {
            ...
            "input_primary_reason": input_reason,
            "input_confidence":     round(input_conf, 4),
            "input_was_sanitized":  input_decision == "SANITIZE",
            "output_decision":      output_decision,
            "output_was_sanitized": output_decision == "SANITIZE",
            "execution_status":     execution_status,
