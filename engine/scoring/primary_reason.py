...
def compute_primary_reason(
    ...
    Priority:
      ...
      3. Toxicity guardrail triggered    -> TOXICITY_GUARDRAIL_BLOCK  (BLOCK-only tier)
    ...
    Note: Toxicity is BLOCK-or-ALLOW only (Bedrock-style); no SANITIZE tier.
    ...
    # Toxicity guardrail - second guardrail priority (BLOCK-only tier)
